...
{
    NONE(null),
    WOOD_PICKAXE(ShopItemShop.constructShopItemToolLevel(new ItemStack(Material.WOOD_PICKAXE, 1), "Wooden Pickaxe", 24, Currency.COINS, 0)),
    STONE_PICKAXE(ShopItemShop.constructShopItemToolLevel(new ItemStack(Material.STONE_PICKAXE, 1), "Stone Pickaxe", 8, Currency.COINS, 1)),
    GOLD_PICKAXE(ShopItemShop.constructShopItemToolLevel(new ItemStack(Material.GOLD_PICKAXE, 1), "Gold Pickaxe", 16, Currency.COINS, 2)),
    DIAMOND_PICKAXE(ShopItemShop.constructShopItemToolLevel(new ItemStack(Material.DIAMOND_PICKAXE, 1), "Diamond Pickaxe", 1, Currency.EMERALDS, 3));
